...
/**
 * SysUsersRolesId generated by hbm2java
 */
public class SysUsersRolesId  implements java.io.Serializable {


     private String userId;
     private String roleId;

    public SysUsersRolesId() {
    }

    public SysUsersRolesId(String userId, String roleId) {
       this.userId = userId;
       this.roleId = roleId;
    }
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof SysUsersRolesId) ) return false;
		 SysUsersRolesId castOther = ( SysUsersRolesId ) other; 
